...
Instead of a fully standalone MCU-controlled device like https://github.com/ardiloot/dif-pressure-meter I wanted some digital detox because I do SW for a living. A **differential pressure probe** can be connected to a multimeter. Or data logger. Or oscilloscope. Such modularity is beneficial, and an analog voltage signal is the most ubiquitous and flexible; "portable" in software terms.
